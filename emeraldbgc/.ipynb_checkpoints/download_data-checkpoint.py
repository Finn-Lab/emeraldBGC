...
INTERPROSCAN_DEST = os.path.join(PKG_DIRECTORY, "interproscan")
...
def reorder_and_clean():
    """ place in correct directories and clean tar.gz"""
    IP_INST = glob.glob(f"{INTERPROSCAN_DEST}*")
    cmmn = os.path.commonprefix(IP_INST)
    os.rename(cmmn, INTERPROSCAN_DEST)
